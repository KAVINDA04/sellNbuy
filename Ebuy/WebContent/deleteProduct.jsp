	...
	<div id="editProductsDiv">
		<div class="registerBox" >
		    ...
		    <form id="productForm" >
		        ...
		        <p>Product Name</p>
		        <input type="text" id="name" placeholder="Enter Name" readonly>
		        <p>Product Price</p>
		        <input type="number" id="price" min="0" step="0.01" placeholder="Enter Price" readonly>
		        ...
		        <p>Quantity</p>
		        <input type="number" id="quantity" min="0" step="1" placeholder="Enter Quantity" readonly>
		        <br><br>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#productForm").submit(function(e){
			...
			var ans = $.ajax({
				type : 'POST',
				url : 'http://localhost:8080/Ebuy/rest/product/deleteproduct',
				dataType : 'json',
			...
			ans.done(function(data){
				if(data['success']=="1"){
					swal("Success!", "Product Delete Successfull!", "success");
					$('#productId').val("");
					$('#name').val("");
					$('#price').val("");
					$('#category').val("");
					...
					swal({
			            title: "Error",
			            text: "Product Delete Unuccessfull",
			            icon: "warning",
			            dangerMode: true,
			        });
				}

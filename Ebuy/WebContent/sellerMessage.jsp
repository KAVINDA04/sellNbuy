	...
	<div class="registerBox">
	    ...
	    <form id="MessageForm" >
	    	...
	    	<select id="userEmail" required>
	    		...
	    		<%
		    		messageService users = new messageService();
					ArrayList<User> arrayList1 = users.getUser();
	    ...
	    <div id="messageDiv">
		    <%
				...
				ArrayList<Message> arrayList = msg.getSellerMsg();
				...
				for (Message messages : arrayList) {
					...
					if(messages.getSeller()==1){
						seller = "To : "+messages.getUser()+" You : ";
					}else{
						seller = messages.getUser()+" : ";
					}
...
<script>
	...
	$(document).ready(function(){
		...
		$("#MessageForm").submit(function(e){
			...
			var ans = $.ajax({
				type : 'POST',
				url : 'http://localhost:8080/Ebuy/rest/message/sellerMessage',
				dataType : 'json',
